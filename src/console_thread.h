...
{
  public:
    ConsoleThread(std::shared_ptr<Profiles> prof, std::shared_ptr<Processes> proc, std::shared_ptr<Logs> logs, std::shared_ptr<FileChooser> file_chooser, std::shared_ptr<Permissions> perms);
    ~ConsoleThread();
