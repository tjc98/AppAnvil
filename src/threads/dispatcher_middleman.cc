...
DispatcherMiddleman::DispatcherMiddleman(std::shared_ptr<Profiles> prof_arg, std::shared_ptr<Processes> proc_arg, std::shared_ptr<Logs> logs_arg, std::shared_ptr<FileChooser> file_chooser_arg, std::shared_ptr<Permissions> perms_arg)
: dispatch(),
  state(NONE),
  data1(""),
  data2(""),
